...
import * as ContentViewerPackage from '@miethe/ui';
...
describe('Re-export parity — components (scenario 10)', () => {
  ...
  // WAVE-002 extractions
  it('exports DiffViewer as a function (component)', () => {
    expect(typeof ContentViewerPackage.DiffViewer).toBe('function');
  });

  it('exports DiffViewerSkeleton as a function (component)', () => {
    expect(typeof ContentViewerPackage.DiffViewerSkeleton).toBe('function');
  });

  it('exports FilePreviewPane as a function (component)', () => {
    expect(typeof ContentViewerPackage.FilePreviewPane).toBe('function');
  });
});
